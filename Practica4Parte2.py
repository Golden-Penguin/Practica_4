...
# Copyright: UIS
# Description: Segunda parte primer inciso
...
class Practica4Parte2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica4Parte2")
        ...
        self.fc = fc = 137100000
        self.GRX = GRX = 0

        ##################################################
        # Blocks
        ##################################################
        self._fc_range = Range(59000000, 500e6, 100e3, 137100000, 200)
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.rational_resampler_xxx_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.fc, self.samp_rate/8)
...
def main(top_block_cls=Practica4Parte2, options=None):
